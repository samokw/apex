        ...
        <section className="px-8 md:px-16 pt-12 pb-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-0">
            ...
            <div className="md:col-span-2 mb-6 md:mb-0">
              <div
                className={`editorial-number select-none ${mounted ? "slide-up" : "opacity-0"}`}
                aria-hidden="true"
              >
                01
              </div>
            ...
            <div className="md:col-span-7 md:border-l md:border-[#1a1a1a] md:pl-10">
              <h1
                className={`font-editorial text-[clamp(3rem,8vw,7.5rem)] leading-[0.9] tracking-tight mb-8 ${mounted ? "slide-up" : "opacity-0"}`}
        ...
        <section className="px-8 md:px-16 py-24 md:py-32" aria-labelledby="pullquote">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-0">
            ...
            <blockquote className="md:col-span-8" id="pullquote">
              <p className="font-editorial text-[clamp(1.5rem,4vw,3.5rem)] leading-[1.15] italic text-[#b3b3b3]">
                &ldquo;Automated testing catches roughly{" "}
                <span className="text-[#f5f5f5] not-italic">57%</span> of accessibility
                failures. The other 43% ship to production, where they become
        ...
        <section className="px-8 md:px-16 pb-24 md:pb-32" aria-labelledby="severity-heading">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0" role="list" aria-label="Severity levels">
            {[
              ...
              >
                <div
                  className="font-editorial text-[clamp(4rem,8vw,7rem)] leading-none italic transition-colors duration-500"
                  style={{ color: "#3d3d3d" }}
        ...
        <section className="px-8 md:px-16 pb-24 md:pb-32" aria-labelledby="cta-heading">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12">
            <div className="md:col-span-8">
              <h2 id="cta-heading" className="font-editorial text-[clamp(2.5rem,6vw,6rem)] leading-[0.9] italic mb-8">
                Ship accessible<br />
